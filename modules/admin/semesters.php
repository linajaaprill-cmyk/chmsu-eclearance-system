...
if(isset($_POST['action'])) {
    ...
    elseif($_POST['action'] == 'delete') {
        $id = intval($_POST['id']);
        $conn->query("DELETE FROM chmsu_semesters WHERE id = $id");
...
<div class="dashboard-wrapper">
    <div class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="?adminsection=semesters" class="active">Semesters</a></li>
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                <ul class="item-list">
                    ...
                    ?>
                    <li>
                        <span><?php echo htmlspecialchars($sem['semester_name']); ?> (<?php echo htmlspecialchars($sem['semester_code']); ?>)</span>
                        <span><?php echo $sem['is_current'] ? 'Current' : ''; ?></span>
                        <span>
                            ...
                            <form method="POST" style="display:inline;">
                                ...
                                <input type="hidden" name="id" value="<?php echo $sem['id']; ?>">
                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Delete this semester?')">Delete</button>
                            </form>
                        </span>
                    </li>
                    <?php endwhile; ?>
