...
if(isset($_POST['action'])) {
    if($_POST['action'] == 'add') {
        ...
        if($check->num_rows > 0) {
            ...
            logActivity($conn, $admin, 'admin', "Added course: $course_code");
            $success = "Course added successfully!";
        }
    }
    // DELETE is now handled by OTP verification in auth.php
}
?>
...
<head>
    ...
    <title>CHMSU E-Clearance System - Manage Courses</title>
...
<div class="dashboard-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="content-card">
            <div class="content-card-header">Add New Course</div>
                ...
                <form method="POST">
                    ...
                    <div class="filter-row">
                        <div class="form-group" style="flex:0 0 120px;">
                            ...
                            <input type="text" name="course_code" placeholder="BSIT" required>
                        </div>
                        <div class="form-group" style="flex:1;">
                            <label>Course Name</label>
                            <input type="text" name="course_name" placeholder="Bachelor of Science in Information Technology" required>
                        </div>
        ...
        <div class="content-card">
            <div class="content-card-header">Course List</div>
            <div class="content-card-body">
                <ul class="item-list">
                    <?php 
                    ...
                    ?>
                    <li>
                        <span><strong><?php echo htmlspecialchars($c['course_code']); ?></strong> - <?php echo htmlspecialchars($c['course_name']); ?></span>
                        <button type="button" class="btn btn-danger btn-sm" onclick="openOTPModal('courses', <?php echo $c['id']; ?>, '<?php echo addslashes($c['course_code'] . ' - ' . $c['course_name']); ?>')">
                    ...
                    ?>
                    <li style="text-align:center;">No courses found. Add your first course above.</li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
