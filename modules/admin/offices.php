...
if(isset($_POST['action'])) {
    if($_POST['action'] == 'add') {
        ...
        if($check->num_rows > 0) {
            ...
            logActivity($conn, $admin, 'admin', "Added office: $office_name");
...
<head>
    ...
    <title>CHMSU E-Clearance System - Manage Offices</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ============================================ */
        /* OTP MODAL - WIDER, SHORTER HEIGHT (SAME AS COURSES) */
        /* ============================================ */
        .otp-modal-overlay {
            display: none;
            position: fixed;
        ...
        /* Status - Green Circle with "Sent" text */
...
<div class="dashboard-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="content-card">
            <div class="content-card-header">Add New Office</div>
                ...
                <form method="POST">
                    ...
                    <div class="filter-row">
                        <div class="form-group" style="flex:1;">
                            ...
                            <input type="text" name="office_name" placeholder="e.g., Registrar, Library, Accounting" required>
                        </div>
        ...
        <div class="content-card">
            <div class="content-card-header">Office List</div>
            <div class="content-card-body">
                <ul class="item-list">
                    <?php 
                    ...
                    ?>
                    <li>
                        <span><strong><?php echo htmlspecialchars($o['office_name']); ?></strong></span>
                        <button type="button" class="btn btn-danger btn-sm" onclick="openOTPModal('offices', <?php echo $o['id']; ?>, '<?php echo addslashes($o['office_name']); ?>')">
                    ...
                    ?>
                    <li style="text-align:center;">No offices found. Add your first office above.</li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
