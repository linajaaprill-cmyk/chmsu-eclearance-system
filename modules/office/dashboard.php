...
<div class="dashboard-wrapper">
    <div class="office-sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="?officesection=dashboard" class="active">Dashboard</a></li>
    ...
    <div class="main-content">
        ...
        <div class="office-grid">
            ...
            <div class="office-card">
                <h4>Approved</h4>
                <div class="count"><?php echo $approvedSubmissions; ?></div>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                <div class="activity-log">
                    <?php
                    $logs = $conn->query("SELECT * FROM chmsu_activity_log WHERE user_type='office' AND user_id='$office' ORDER BY created_at DESC LIMIT 20");
